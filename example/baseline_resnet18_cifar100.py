...
wandb.init(
    project="baseline_resnet18_cifar100",
    config={
        "K": K,
...
# Results Directory
# -------------------------
results_dir = f"results_cifar100_baseline_seed{seed}"
...
final_model_filename = f"{results_dir}/cifar100_fedavg_baseline_K{K}_lr{initial_lr}_c{c}_steps{num_steps}_bs{batch_size_per_client}_seed{seed}.pt"
